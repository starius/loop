...
// testSweepBatcherSkippedTxs tests that option WithSkippedTxs
// works as expected.
func testSweepBatcherSkippedTxs(t *testing.T, store testStore,
	batcherStore testBatcherStore) {
	...
	batcher = NewBatcher(
		...
		testMuSig2SignSweep, testVerifySchnorrSig, lnd.ChainParams,
		batcherStore, sweepStore,
		WithSkippedTxs(map[chainhash.Hash]struct{}{
			op1.Hash: {},
		}),
	)
	wg.Add(1)
...
// TestSweepBatcherSkippedTxs tests that option WithSkippedTxs
// works as expected.
func TestSweepBatcherSkippedTxs(t *testing.T) {
	runTests(t, testSweepBatcherSkippedTxs)
}
