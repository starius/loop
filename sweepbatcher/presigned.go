...
// this group only. This method is called when a group of sweeps of new swap is
// being added to the batch. If the batch can be either empty or existing. This
// is know to the caller and affects allowNonEmptyBatch flag.
