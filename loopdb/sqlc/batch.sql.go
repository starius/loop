...
func (q *Queries) GetParentBatch(ctx context.Context, outpoint []byte) (SweepBatch, error) {
...
func (q *Queries) GetSweepStatus(ctx context.Context, outpoint []byte) (bool, error) {
