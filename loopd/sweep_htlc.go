...
func sweepHtlc(ctx context.Context, req *looprpc.SweepHtlcRequest,
	...
	infof("sweephtlc: PkScript validated for %v", req.Outpoint)
	...
	infof("sweephtlc: preimage validated for %v", req.Outpoint)
	...
	if err := targetHtlc.AddSuccessToEstimator(&estimator); err != nil {
		return nil, err
	}
	if err := sweep.AddOutputEstimate(&estimator, sweepAddr); err != nil {
		return nil, err
	}
	...
	sweepTx.AddTxOut(&wire.TxOut{
		...
		Value:    int64(htlcValue) - int64(fee),
	})
